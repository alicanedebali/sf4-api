...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    'FOS\\UserBundle\\Form\\Type\\ChangePasswordFormType' => array('privates', 'fos_user.change_password.form.type', 'getFosUser_ChangePassword_Form_TypeService.php', true),
    'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => array('privates', 'fos_user.profile.form.type', 'getFosUser_Profile_Form_TypeService.php', true),
    'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => array('privates', 'fos_user.registration.form.type', 'getFosUser_Registration_Form_TypeService.php', true),
    'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => array('privates', 'fos_user.resetting.form.type', 'getFosUser_Resetting_Form_TypeService.php', true),
    'FOS\\UserBundle\\Form\\Type\\UsernameFormType' => array('privates', 'fos_user.username_form_type', 'getFosUser_UsernameFormTypeService.php', true),
    ...
    yield 6 => ($this->privates['Nelmio\ApiDocBundle\Form\Extension\DocumentationExtension'] ?? ($this->privates['Nelmio\ApiDocBundle\Form\Extension\DocumentationExtension'] = new \Nelmio\ApiDocBundle\Form\Extension\DocumentationExtension()));
