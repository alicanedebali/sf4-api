...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'fos_user.command.activate_user' => array('privates', 'fos_user.command.activate_user', 'getFosUser_Command_ActivateUserService.php', true),
    'fos_user.command.change_password' => array('privates', 'fos_user.command.change_password', 'getFosUser_Command_ChangePasswordService.php', true),
    'fos_user.command.create_user' => array('privates', 'fos_user.command.create_user', 'getFosUser_Command_CreateUserService.php', true),
    'fos_user.command.deactivate_user' => array('privates', 'fos_user.command.deactivate_user', 'getFosUser_Command_DeactivateUserService.php', true),
    'fos_user.command.demote_user' => array('privates', 'fos_user.command.demote_user', 'getFosUser_Command_DemoteUserService.php', true),
    'fos_user.command.promote_user' => array('privates', 'fos_user.command.promote_user', 'getFosUser_Command_PromoteUserService.php', true),
