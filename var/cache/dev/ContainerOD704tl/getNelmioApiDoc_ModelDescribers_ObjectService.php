...
return $this->privates['nelmio_api_doc.model_describers.object'] = new \Nelmio\ApiDocBundle\ModelDescriber\ObjectModelDescriber(($this->privates['property_info'] ?? $this->load('getPropertyInfoService.php')), ($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), new RewindableGenerator(function () {
